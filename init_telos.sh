...
then        
    ...
    then
        ...
        then
            ...
            apt install ./eosio_2.0.0-1-ubuntu-18.04_amd64.deb
        else
        ...
        if [ $instVer == "1" ]
        then
            ln -s /usr/opt/eosio/2.0.0-1/bin/nodeos /ext/telos/nodeos
            ln -s /usr/opt/eosio/2.0.0-1/bin/cleos /ext/telos/cleos
	else    
