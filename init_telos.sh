...
apt install -y software-properties-common git ntpstat jq pigz nodejs npm mongodb-server golang ntp python-pip python3-pip zfsutils-linux net-tools salt-minion schedtool stress cpufrequtils lm-sensors linux-tools-generic htop iotop tree
